...
class Usuario extends ActiveRecord {
    ...
    */
    ...
    public function crear($datos)
    {
      ...
      $usuario->password = 'baf18e593117ed4657ed47572624fbe4d4f69d79'; //casa1357
      $usuario->perfil_id = 2; //Perfil de acceso de nivel Bajo
      $usuario->email = $datos['correo'];
      $usuario->tema = 'default';
      $usuario->app_ajax = 1;
      $usuario->datagrid = 30;
      $usuario->fotografia = 'default.png';
      $usuario->usuario_at = date('Y-m-d H:i:s');
